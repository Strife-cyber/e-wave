                    ...
                    <div class="relative z-10 mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
                        <div class="animate-fade-in-down max-w-3xl">
                            ...
                            <p class="flex items-center text-lg text-gray-700 dark:text-gray-300">
                                <span class="mr-2 flex h-8 w-8 items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900/50">
                                    <svg
                        ...
                        <div class="animate-fade-in space-y-8 lg:col-span-2">
                            ...
                            >
                                ...
                                <div class="mt-6 flex items-center text-sm text-purple-600 dark:text-purple-400">
                                    <span class="mr-2 flex h-5 w-5 items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900/50">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="ml-5 flex-1">
                                                ...
                                                <div class="mt-3 flex items-center text-xs text-purple-600 dark:text-purple-400">
                                                    <span
                                                        class="mr-2 flex h-4 w-4 items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900/50"
                                                    >
                                                        <svg
                                                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="animate-fade-in-up space-y-6">
                            ...
                            >
                                <h2 class="mb-4 flex items-center text-xl font-bold text-gray-900 dark:text-white">
                                    <span class="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-purple-100 dark:bg-purple-900/50">
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            class="h-3 w-3 text-purple-600 dark:text-purple-300"
                                            fill="none"
                            ...
                            >
                                ...
                                <ul class="space-y-3">
                                    <li
                                        v-for="group in course?.groups.slice(0, 5)"
                                        :key="group.id"
