...
import { Award, BarChart2, BookOpen, Calendar, MessageCircle, Shield, Users } from 'lucide-vue-next';
...
<template>
    ...
    <div class="relative min-h-screen bg-gray-50 dark:bg-black">
        ...
        <AppLayout :breadcrumbs="breadcrumbs">
            <div class="flex h-full flex-1 flex-col gap-6 rounded-xl bg-white/80 p-6 backdrop-blur-sm dark:bg-black">
                <!-- Welcome Section -->
                <div class="animate-fade-in mb-8 p-4">
                    <h2 class="font-pacifico text-2xl text-gray-800 dark:text-gray-100">
                ...
                <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <!-- Progress Card -->
                    <div class="animate-fade-in rounded-xl bg-white p-6 shadow-md transition-all hover:shadow-lg dark:bg-gray-800">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="progress-bar-container h-2.5 w-full rounded-full bg-gray-200 dark:bg-gray-700">
                                <div class="progress-bar h-2.5 rounded-full bg-purple-600" :style="{ width: `${completionPercentage}%` }"></div>
                            </div>
                        </div>
                    ...
                    <div class="animate-fade-in rounded-xl bg-white p-6 shadow-md transition-all hover:shadow-lg dark:bg-gray-800">
                        ...
                        <div class="mb-4 flex items-end">
                            <span class="rewards-count text-3xl font-bold text-gray-800 dark:text-gray-100">{{ rewards }}</span>
                    ...
                    <div class="animate-fade-in rounded-xl bg-white p-6 shadow-md transition-all hover:shadow-lg dark:bg-gray-800">
                        ...
                        <div class="mb-4 flex items-end">
                            <span class="badges-count text-3xl font-bold text-gray-800 dark:text-gray-100">{{ badges.length }}</span>
                ...
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                    ...
                    <div class="animate-fade-in rounded-xl bg-white shadow-md dark:bg-gray-800">
                        <div class="flex items-center justify-between border-b border-gray-200 px-6 py-5 dark:border-gray-700">
                            ...
                            <a href="/user/courses" class="flex items-center text-sm font-medium text-purple-600 hover:text-purple-800">
                                View all
                                <svg class="ml-1 h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                    <path
                                        fill-rule="evenodd"
                                ...
                                >
                                    <div class="flex items-start justify-between">
                                        <div>
                                            ...
                                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">{{ course.description }}</p>
                                        ...
                                        <button
                                            class="h-8 w-8 rounded-full text-purple-600 transition-colors hover:bg-purple-50 hover:text-purple-800 dark:hover:bg-purple-900/30"
                                        >
                        ...
                        <div class="p-6">
                            ...
                            <div v-else class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                ...
                                >
                                    ...
                                    <h4 class="mb-2 font-medium text-gray-800 dark:text-gray-100">{{ card.title || `Review Card #${card.id}` }}</h4>
                                    <p class="text-sm text-gray-600 dark:text-gray-300">{{ card.content || 'No content available' }}</p>
                                    <div class="mt-4 flex items-center justify-between">
                                        <button class="text-xs font-medium text-purple-600 hover:text-purple-800">Edit</button>
                                        <button
                        ...
                        <div class="p-6">
                            ...
                            <div v-else class="space-y-4">
                                <div
                                    ...
                                    :key="group.id"
                                    class="message-card rounded-lg border border-gray-200 p-4 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-700"
                                >
                                    <div class="mb-2 flex items-start justify-between">
                                        <h4 class="flex items-center font-medium text-gray-800 dark:text-gray-100">
                                            <MessageCircle class="mr-2 h-4 w-4 text-purple-600 dark:text-purple-400" />
                                    ...
                                    <p class="mb-3 text-sm text-gray-600 dark:text-gray-300">{{ group.latest_message.content }}</p>
                                    <div class="flex items-center justify-between">
                                        <span class="text-xs text-gray-500 dark:text-gray-400">From: User #{{ group.latest_message.user_id }}</span>
                                        <button class="text-xs font-medium text-purple-600 hover:text-purple-800">Reply</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-6">
                            ...
                            <div v-else class="grid grid-cols-2 gap-4">
                                <div v-for="badge in badges" :key="badge.id" class="badge-item flex flex-col items-center">
                                    <div
                                        class="badge-icon mb-2 flex h-16 w-16 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900/30"
                                    >
                                        <Shield class="h-8 w-8 text-blue-600 dark:text-blue-400" />
                                    </div>
                                    <span class="text-center text-sm font-medium text-gray-800 dark:text-gray-100">{{
                                        badge.name || 'Achievement Badge'
                                    }}</span>
                                    <span class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ formatDate(badge.created_at) }}</span>
                                </div>
                            </div>
                            <div class="mt-4 text-center">
                                <button class="text-sm font-medium text-purple-600 hover:text-purple-800">View all badges</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Upcoming Deadlines -->
                    <div class="animate-fade-in rounded-xl bg-white shadow-md dark:bg-gray-800">
                        <div class="flex items-center border-b border-gray-200 px-6 py-5 dark:border-gray-700">
                            <Calendar class="mr-2 h-5 w-5 text-purple-600 dark:text-purple-400" />
